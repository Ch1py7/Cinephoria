...
export const MoviePage: FC = (): ReactElement => {
  ...
  const { data: recommendationsData } = useFetch<MovieTypes.Movie>(
    ...
    <S.MoviePage>
      ...
      <S.MovieInformation>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          ...
          <div>
            <S.MovieDescription fontSize='1.4rem'>
              <Icon
                icon='bx:bxs-star'
          ...
          <S.MovieDescription fontSize='1.8rem'>
            {data?.overview}
          </S.MovieDescription>
          <div>
            <S.MovieDescription style={{ color: '#8c8c8c' }} fontSize='1.6rem'>
              Tagline:
            </S.MovieDescription>
            <S.MovieDescription style={{ color: '#e1e1e1' }} fontSize='1.8rem'>
              {data?.tagline}
            </S.MovieDescription>
            <S.MovieDescription
