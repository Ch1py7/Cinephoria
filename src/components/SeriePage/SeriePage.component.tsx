...
export const SeriePage: FC = (): ReactElement => {
  ...
  const { data: recommendations } = useFetch<MovieTypes.Movie>(
    ...
    <S.SeriePage>
      ...
      <S.SerieInformation>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          ...
          <div>
            <S.SerieDescription fontSize='1.4rem'>
              <Icon
                icon='bx:bxs-star'
            ...
            <S.SerieDescription fontSize='1.4rem'>
              <Icon icon='uiw:time-o' style={{ marginRight: '1rem' }} />
              {serieDuration}
            </S.SerieDescription>
            <S.SerieDescription fontSize='1.4rem'>
              <Icon icon='ph:calendar-bold' style={{ marginRight: '1rem' }} />
              {data?.first_air_date}
            </S.SerieDescription>
          </div>
          <S.SerieSubTitle fontSize='2.2rem'>Overview</S.SerieSubTitle>
          <S.SerieDescription fontSize='1.8rem'>
            {data?.overview}
          </S.SerieDescription>
          <div>
            <S.SerieDescription style={{ color: '#8c8c8c' }} fontSize='1.6rem'>
              Tagline:
            </S.SerieDescription>
            <S.SerieDescription style={{ color: '#e1e1e1' }} fontSize='1.8rem'>
              {data?.tagline}
            </S.SerieDescription>
            <S.SerieDescription
              style={{ marginTop: '2rem', color: '#8c8c8c' }}
              fontSize='1.6rem'
            >
              Genre:
            </S.SerieDescription>
