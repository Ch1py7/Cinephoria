...
export const BurgerOptions: FC<BurgerOptionsProps> = ({
  isMenuOpen,
  onClickBurger,
}): ReactElement => {
  return (
    <>
      <S.BurgerOptions className={isMenuOpen ? 'showMenu' : 'noShowMenu'}>
        ...
        <ol style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          ...
          <li>
            <S.Link onClick={onClickBurger} to='/search'>
              Search
            </S.Link>
          </li>
          <li>
            <S.Link onClick={onClickBurger} to='/trending'>
              Trending Now
            </S.Link>
          </li>
